...
function HeroSection() {
  return (
    <div className="bg-grid-white/[0.02] relative mx-auto flex h-auto w-full flex-col items-center justify-center overflow-hidden rounded-md py-10 md:h-[40rem] md:py-0 lg:h-[50rem] xl:h-[60rem]">
