...
import { Edit2, Lock, PenIcon } from 'lucide-react'
    ...
    return (
        <Wrapper className="flex min-h-screen flex-col items-center justify-center py-16">
                    ...
                    <div className="from-bg-[#000000] via-bg-[#000000] to-background text-primary flex flex-col items-center justify-center bg-gradient-to-b px-10 py-16">
                        ...
                        <div className="relative mt-6">
                            <Image
                                ...
                                width={120}
                                height={120}
                                className="h-40 w-40 md:h-80 md:w-80 rounded-full object-cover border-4 border-white/20 shadow-lg transition-transform duration-300 hover:scale-105"
                            />
                            {isEditing && (
                                <button
                                    type="button"
                                    ...
                                    className="absolute bottom-0 right-0 rounded-full bg-[#f10a0a] p-2 text-white hover:bg-[#d10909]"
                                >
            ...
            <AnimationContainer animation="fadeUp" delay={0.3} className="mt-8 w-auto max-w-4xl">
                <div className="relative overflow-hidden rounded-[40px] bg-black/10 backdrop-blur-md p-8 dark:bg-white/5">
