...
const AboutUs = () => {
  return (
    <Wrapper className="relative h-full min-h-screen w-full flex-1 pt-20 lg:pt-32">
      <div className="flex h-full w-full flex-col items-center gap-10 py-8">
        {/* Section Header */}
            ...
            <MagicCard className="mt-10 rounded-xl p-6 sm:p-8 md:p-8">
              <AnimationContainer animation="fadeUp" delay={0.6}>
                <p className="text-muted-foreground text-sm sm:text-base md:text-base lg:text-lg">
                  Creator's World began as a simple dream of a 13-year-old who wanted to build a big
                  Discord server but had no clear direction. A year later, with a deeper look into
                  ...
                  world, featuring over 1,000 bots and a thriving community. Today, Creator's World
                  has evolved into more than just a server—it is now a company dedicated to creating
                  open-source projects, building modern web applications for clients, and providing
                  a space for innovation, tools, and collaboration for users, developers, and
