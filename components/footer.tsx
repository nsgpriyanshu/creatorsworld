...
const PRODUCT_LINKS: FooterLink[] = [
    { label: 'Emo Pack', href: '/products', icon: Package },
]
                                    ...
                                    return (
                                        <AnimationContainer key={index} animation="scaleUp" delay={0.4 + index * 0.1}>
                                            <Link
                                                ...
                                                target="_blank"
                                                title={social.label}
                                                className="text-foreground transition-all duration-300 hover:text-[#f10a0a] hover:scale-110"
                                            >
                                ...
                                <div>
                                    ...
                                    <ul className="text-foreground mt-4 space-y-3 text-sm">
                                        {PRODUCT_LINKS.map((link, index) => {
                                            ...
                                            return (
                                                <AnimationContainer key={index} animation="fadeLeft" delay={0.4 + index * 0.1}>
                                                    <li>
                                                        <Link
                                                            href={link.href}
                                                            className="flex items-center gap-2 transition-all duration-300 hover:text-[#f10a0a] hover:translate-x-1"
                                                        >
